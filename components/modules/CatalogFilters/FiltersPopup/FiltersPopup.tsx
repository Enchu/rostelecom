        ...
        {filtersPopup && (
          ...
          >
            ...
            >
              ...
              <motion.div className={styles.catalog__filters__popup__category} variants={itemVariants}>
              ...
              <motion.div className={styles.catalog__filters__popup__sizes} variants={itemVariants}>
                <SizesFilter handleApplyFiltersWithSizes={handleApplyFiltersWithSizes} />
              </motion.div>
              <motion.div className={styles.catalog__filters__popup__colors} variants={itemVariants}>
                <ColorsFilter handleApplyFiltersWithColors={handleApplyFiltersWithColors} />
              </motion.div>
              <motion.button
                variants={itemVariants}
