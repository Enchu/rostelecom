  ...
  return (
    <div className={styles.empty_content}>
      ...
      <div className={styles.empty_content__inner}>
        <span className={`${styles.empty_content__word} ${bgWordClassName ? bgWordClassName : ''}`}>
          {emptyWord ? emptyWord : translations[lang].common.empty}
        </span>
        {!isMedia950 && (
          <ContentTitle title={currentTitle} oopsWord={currentOopsWord} />
        )}
        <div className={styles.empty_content__subtitle} dangerouslySetInnerHTML={{ __html: subtitle }} />
